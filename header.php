...
<body <?php body_class(); ?> id='top'>
    <div class="mc-fixed-header" id="HandlerMenu">
                ...
                <header>
                    ...
                    <div class="side-popup-overlay" id="popupOverlay">
                        ...
                        <div class="side-popup" id="sidePopup">
                            <div class="header-logo mc-logo-mg-pop">
                            ...
                            <div class="contact-control">
                                <a href="tel: <?php echo get_field("sdt_footer", "option"); ?>"><img src="<?php echo get_template_directory_uri();
                                                                                                            ?>/assets/images/header-phone.svg" alt="Phone icon" />
                                    <?php echo get_field("sdt_footer", "option"); ?></a>
